...
const Footer = () => {
  const { phone, address, social, year } = {
    phone: "+123 456 7890",
    address: "Debre Berhan Blood Bank, Debre Berhan, Ethiopia",
    social: { facebook: "#", telegram: "#" },
    year: new Date().getFullYear(),
  };

  // Google Maps link for Debre Berhan Blood Bank
  const googleMapsLink =
    "https://www.google.com/maps/search/?api=1&query=9.66,39.53";

  return (
    <footer className="bg-gray-50 border-t py-8 px-4 transition duration-300 ease-in-out hover:bg-gray-100">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
          <div className="flex items-center gap-2">
            <svg
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition duration-200 ease-in-out"
            >
              <svg
                className="w-5 h-5 text-blue-600"
                viewBox="0 0 20 20"

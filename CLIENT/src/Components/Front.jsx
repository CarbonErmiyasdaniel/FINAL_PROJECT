...
const Front = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-gray-900">
      ...
      <div className="absolute inset-0">
        <div
          className={`w-full h-full bg-gray-700 flex items-center justify-center transition-opacity duration-500 ${
            isTransitioning ? "opacity-0" : "opacity-100"
          }`}
        >
          {/* Placeholder for the image */}
          <div className="w-full h-full bg-gray-500 flex items-center justify-center text-white text-2xl">
            Image Placeholder
          </div>
        </div>
        <div

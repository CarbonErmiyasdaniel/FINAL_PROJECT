    ...
    <div className="p-6 bg-gradient-to-br from-red-50 to-white min-h-screen">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
          <Users className="text-red-700" /> Donor List
        </h1>
                  ...
                  <td className="px-6 py-4">
                    {donor.hasPersonalInfo ? (
                      <span className="text-green-700 font-medium flex items-center gap-1">
                        <CheckCircle className="w-4 h-4" /> Info Added
                      </span>
                    ) : (
                      <span className="text-orange-600">Pending Info</span>
                    )}
                  </td>

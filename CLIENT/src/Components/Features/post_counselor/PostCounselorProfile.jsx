...
const PostCounselorProfile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const res = await axios.get("/api/post-counselor/me", {
        // Updated endpoint
  ...
  const handleUploadPhoto = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.patch("/api/post-counselor/photo", formData, {
        // Updated endpoint
        headers: {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.patch(
        "/api/post-counselor/change-password", // Updated endpoint

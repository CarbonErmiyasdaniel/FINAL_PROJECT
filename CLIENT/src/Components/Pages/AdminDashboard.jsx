...
// // can you add the hospital request page here?
...
//         />
//         <SidebarButton
//           onClick={() => handleNavigate("/admin/hospital-requests")}
//           icon={<ClipboardList />}
//           label="Hospital Requests"
//           isExpanded={isSidebarOpen}
//           isActive={currentPage === "/admin/hospital-requests"}
//         />
//         <SidebarButton
...
import NurseActivityReports from "../Features/admin/NurseActivityReports";
import UserStatsDashboard from "../Features/admin/UserStatsDashboard";
import AnalyticsDashboard from "../Features/admin/AnalyticsDashboard"; // Added
import DashboardContent from "../Features/admin/DashboardContent";
...
const AdminDashboard = () => {
  ...
  const RenderPage = () => {
    switch (currentPage) {
      ...
      case "/admin/analytics": // Added this
